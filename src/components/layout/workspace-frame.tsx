...
export function WorkspaceFrame({
  ...
  return (
    <div className="min-h-screen bg-app-bg text-app-ink md:grid md:grid-cols-[56px_minmax(0,1fr)]">
      <aside
        className="border-b border-app-border bg-app-surface px-4 py-3 md:hidden"
      ...
      <aside
        className="group/sidebar relative z-40 hidden h-screen w-14 overflow-visible border-r border-app-border bg-app-surface md:sticky md:top-0 md:block"
        aria-label="Job Flow sidebar"
